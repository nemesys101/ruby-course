...
* 10:30 -11:30 *Introducción to Ruby*
...
En Ruby __casi todo__ es un objeto. El tipo del objeto es definido por lo que el objeto puede hacer. A esto le llamamos "duck typing". Si un objeto camina como un pato y habla como un pato, entonces el interprete lo trata como un pato.
% Esto no está muy claro o muy bien expresado ...
...
% Esto no es 100% correcto. El método .class devuelve la clase a partir de la cuál se creó el objeto. En el ejemplo anterior sobre tipo, numbers.class devuelve Array, pero Array no es el tipo del objeto, o sea, no es "Lo que el objeto puede hacer". Lo cambiaria por:
...
* Las tiene built-in en el lenguaje
